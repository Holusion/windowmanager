  ...
  which.on("close",function(e){
    ...
    return callback(null,{
      open:function(path,cb){
        ...
        child_process = spawn(self.executableName,[path], {stdio:"inherit",detached:true});//Make child create it's own group
